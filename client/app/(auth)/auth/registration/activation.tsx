            ...
            <SafeAreaView style={{ flex: 1 }} collapsable={true}>
                <ScrollView style={{
                    ...
                    <View style={{ ...gstyles.container, ...gstyles.container_center }}>
                        ...
                        <Text style={gstyles.t_header}>Preparing your account</Text>
                        <Spacer size={10} />
                        <View style={gstyles.container_forms}>
                            <Text style={{ ...gstyles.t_base_dark, textAlign: "center", fontSize : 14 }}>Email has been successfully validated, we are now preparing your account</Text>
                            <Spacer size={20} />
