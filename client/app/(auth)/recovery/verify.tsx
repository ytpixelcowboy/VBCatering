            ...
            <SafeAreaView style={{ flex: 1 }} collapsable={true}>
                <ScrollView style={{
                    ...
                    <View style={{ ...gstyles.container, ...gstyles.container_center }}>
                        ...
                        <Text style={gstyles.t_header}>Confirm reset passowrd</Text>
                        <Spacer size={10} />
                        <View style={gstyles.container_forms}>
                            <Text style={{ ...gstyles.t_base_dark, textAlign: "center",fontSize : 14 }}>An email has been sent to [CLIENT PROVIDED EMAIL] that contains a magic link to verify password reset request, You may check your spam folder in case you cannot find the email</Text>
                            <Spacer size={20} />
                            ...
                            <TouchableOpacity style={gstyles.btn_primary} onPress={() => {
                                router.replace("/(auth)/recovery/updatepassword")
                            }}>
                                <Text style={gstyles.t_semibold_dark}>RESEND CODE</Text>
                            </TouchableOpacity>
                            <Spacer size={8} />
